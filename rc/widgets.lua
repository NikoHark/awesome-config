...
alsawidget =
{
  ...
  cardnumber = "0",
	...
	notifications =
	{
		...
		font = "Monospace 15", -- must be a monospace font for the bar to be sized consistently
		icon_size = 48,
...
alsawidget.bar:buttons (awful.util.table.join (
	...
	awful.button ({}, 3, function()
                ...
                awful.util.spawn ("amixer sset -c " .. cardnumber .. " " .. alsawidget.channel .. " toggle")
